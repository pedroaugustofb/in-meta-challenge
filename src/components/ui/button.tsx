...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-300",
  {
    variants: {
      variant: {
        default: "bg-primary-500 text-zinc-50 shadow hover:bg-primary-500/90 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90",
        ...
        secondary: "bg-secondary-300 text-zinc-900 shadow-sm hover:bg-secondary-300/80 dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-800/80",
